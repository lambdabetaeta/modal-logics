...
dual-prod1 = DK-lam (DK-lam (DK-prod (DK-var (pop top)) (DK-var top)))
...
K-hilb-to-dual K-prod3 = DK-lam (DK-snd (DK-var top))
...
K-dual-to-hilb-corr :  ∀ {Γ A}

  -> · / Γ ⊢ A
  ------------
  -> ThmK Γ A

K-dual-to-hilb-corr {Γ} {A} p =
  subst (λ Δ → ThmK Δ A) (leftid++ Γ) (K-dual-to-hilb p)
